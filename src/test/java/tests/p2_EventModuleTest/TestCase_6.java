...
public class TestCase_6 {
    ...
    public void test06() throws InterruptedException {
        ...
        pitonEditEventPage.editDateBox.sendKeys(Keys.chord(Keys.CONTROL, "a", Keys.DELETE));
        pitonEditEventPage.editDateBox.sendKeys("11/01/2022");
        ...
        // Bu adimda date kismini temizlerken control+a ile hepsini seçip delete ile temizleyerek yeni bilgi girisi saglandi
